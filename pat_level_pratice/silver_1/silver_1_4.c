...
//
//7-4 装睡 (10分)
//https://pintia.cn/problem-sets/1146682252642181120/problems/1146696302235181056
...
bool IsSleep(Man man) {
    if (man->Breath <= MAX_BREATH && man->Breath >= MIN_BREATH && man->Pulse <= MAX_PULSE && man->Pulse >= MIN_PULSE) {
        return true;
    }
    return false;
}